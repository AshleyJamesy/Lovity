...
function class:calculate(projection, view)
	--TODO:
	--[[
...
function class:pointInFrustum(x, y, z)
	for i = 0, 5 do
		local j = i * 4
...
function class:sphereInFrustum(x, y, z, radius)
	for i = 0, 5 do
		local j = i * 4
...
function class:cubeInFrustum(x, y, z, size)
	for i = 0, 5 do
		local j = i * 4
