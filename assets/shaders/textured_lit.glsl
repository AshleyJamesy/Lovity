...
uniform Light lights[NR_POINT_LIGHTS];
    ...
    void effect() {
        ...
        love_Canvases[0] = albedo * vec4(Colour, 1.0);
    	love_Canvases[1] = albedo * vec4(Colour, 1.0);
        love_Canvases[2] = albedo * vec4(Colour, 1.0);
        love_Canvases[3] = albedo * vec4(Colour, 1.0);
    }
#endif